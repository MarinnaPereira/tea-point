  ...
  return (
    <>
      <section>
        ...
        <p className="text-center text-[#5f5f5f] italic px-4">Savor the essence of Asia with our exclusive single-origin teas.</p>
      <p className="text-center text-[#5f5f5f] italic px-4">Expertly crafted to capture each region's unique character, our collection reflects the artistry of skilled tea makers.</p>
      ...
      <section className="pb-5">
        ...
        <p className="text-center text-[#5f5f5f] italic px-4">Elevate your tea experience with our meticulously crafted teaware.</p>
        <p className="text-center text-[#5f5f5f] italic px-4">Indulge in a simple and mindful brewing ritual that enhances the essence of each cup.</p>
        <div className="w-fit mx-auto grid grid-cols-1 lg:grid-cols-3 md:grid-cols-2 justify-items-center justify-center gap-y-20 gap-x-14 mt-10 mb-5 lg:px-32 md:px-24 px-12">
          {teaWare.map((product) => (
            <div key={product.id} className="relative group">
              <img
